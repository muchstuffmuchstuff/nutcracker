...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 4, 'FACTORY' }},
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'NC T1 Power Engineer - Rush Early',
        PlatoonTemplate = 'EngineerBuilderSorian',
        Priority = 1000,
        BuilderConditions = {
            #{ UCBC, 'EngineerLessAtLocation', { 'LocationType', 3, 'ENGINEER TECH2, ENGINEER TECH3' } },
    ...
    Builder {
        BuilderName = 'NC T1 Power Engineer - Rush',
        PlatoonTemplate = 'EngineerBuilderSorian',
        Priority = 1000,
        BuilderConditions = {
            #{ UCBC, 'EngineerLessAtLocation', { 'LocationType', 3, 'ENGINEER TECH2, ENGINEER TECH3' } },
...
{ SIBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
    ...
    Builder {
        BuilderName = 'NC T3 Power Engineer',
...
{ SIBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
          ...
          { SIBC, 'LessThanEconEfficiency', { 2.0, 1.0 }},
    ...
    Builder {
        BuilderName = 'NC T3 Power Engineer - Emergency',
        PlatoonTemplate = 'T3EngineerBuilderSorian',
        Priority = 2000,
        BuilderType = 'Any',
        BuilderConditions = {
...
{ SIBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
    ...
    Builder {
        BuilderName = 'NC T3 Power Engineer - init',
        PlatoonTemplate = 'T3EngineerBuilderSorian',
        Priority = 1500,
        BuilderType = 'Any',
        BuilderConditions = {
...
{ SIBC, 'HaveLessThanUnitsInCategoryBeingBuilt', { 1, 'ENERGYPRODUCTION TECH2, ENERGYPRODUCTION TECH3' } },
    ...
    Builder {
        BuilderName = 'NC T3 Power Engineer Expansions',
        PlatoonTemplate = 'T3EngineerBuilderSorian',
        Priority = 1000,
        BuilderType = 'Any',
        BuilderConditions = {
...
BuilderGroup {
    ...
    # Initial builder
    Builder {
        BuilderName = 'NC CDR Initial Balanced',
...
BuilderGroup {
    ...
    #Builder {
    #    BuilderName = 'NC T1 Engineer Assist Shield',
    #    PlatoonTemplate = 'EngineerAssistSorian',
    #    Priority = 825,
    #    BuilderConditions = {
    #        { IBC, 'BrainNotLowPowerMode', {} },
    ...
    #},
    #Builder {
    #    BuilderName = 'NC T1 Engineer Assist Transport',
    #    PlatoonTemplate = 'EngineerAssistSorian',
    #    Priority = 875,
    #    BuilderConditions = {
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'NC T2 Engineer Find Unfinished',
        PlatoonTemplate = 'T2EngineerBuilderSorian',
        PlatoonAIPlan = 'ManagerEngineerFindUnfinished',
        Priority = 1800,
        InstanceCount = 1,
    ...
    Builder {
        BuilderName = 'NC T2 Engineer Assist Transport',
        PlatoonTemplate = 'T2EngineerAssistSorian',
        Priority = 875,
        BuilderConditions = {
            { UCBC, 'LocationFactoriesBuildingGreater', { 'LocationType', 0, 'TRANSPORTFOCUS' } },
...
BuilderGroup {
    ...
    # =========================
    Builder {
        BuilderName = 'NC T3 Energy Storage Engineer',
        PlatoonTemplate = 'T3EngineerBuilderSorian',
        Priority = 550,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Reclaim',
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Find Low Shield',
        PlatoonTemplate = 'T3EngineerBuilderOnlySorian',
        PlatoonAIPlan = 'ManagerEngineerFindLowShield',
        Priority = 1801,
        InstanceCount = 3,
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Reclaim Excess',
        PlatoonTemplate = 'T3EngineerBuilderOnlySorian',
        PlatoonAIPlan = 'ReclaimAISorian',
        Priority = 1,
        InstanceCount = 50,
   ...
   Builder {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Assist Mass Fab',
        PlatoonTemplate = 'T3EngineerAssistSorian',
        Priority = 800,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Assist Defenses',
        PlatoonTemplate = 'T3EngineerAssistSorian',
        Priority = 750,
        InstanceCount = 1,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Assist Shields',
        PlatoonTemplate = 'T3EngineerAssistSorian',
        Priority = 750,
        InstanceCount = 2,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Assist Factory',
        PlatoonTemplate = 'T3EngineerAssistSorian',
        Priority = 700,
        InstanceCount = 20,
        BuilderConditions = {
...
BuilderGroup {
    ...
    # ============
    Builder {
        BuilderName = 'NC T1 Engineer Disband - Init',
    ...
    # ============
    Builder {
        BuilderName = 'NC T2 Engineer Disband - Init',
    ...
    Builder {
        BuilderName = 'NC T2 Engineer Disband - Filler 2',
        PlatoonTemplate = 'T2BuildEngineer',
        Priority = 700,
        BuilderConditions = {
            { SIBC, 'GreaterThanEconEfficiencyOverTime', { 0.9, 1.2 } },
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Disband - Filler',
        PlatoonTemplate = 'T3BuildEngineer',
        Priority = 925,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Disband - Filler 2',
        PlatoonTemplate = 'T3BuildEngineer',
        Priority = 900,
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC T3 Engineer Disband - Filler 3 Econ',
        PlatoonTemplate = 'T3BuildEngineer',
        Priority = 960,
        BuilderConditions = {
    ...
    # ====================
    Builder {
        BuilderName = 'NC T3 Sub Commander',
...
BuilderGroup {
    ...
    #},
    #Builder {
    #    BuilderName = 'NC CDR Assist Mass Extractor Upgrade',
    #    PlatoonTemplate = 'CommanderAssistSorian',
    #    Priority = 0,
    #    BuilderConditions = {
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'NC UEF CDR Upgrade T3 Eng - Shields',
        PlatoonTemplate = 'CommanderEnhanceSorian',
        BuilderConditions = {
    ...
    Builder {
        BuilderName = 'NC Aeon CDR Upgrade T3 Eng - ResourceAdv - EnhSensor',
        PlatoonTemplate = 'CommanderEnhanceSorian',
        BuilderConditions = {
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'FACTORY TECH2, FACTORY TECH3'}},
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
    ...
    Builder {
        BuilderName = 'NC Cybran CDR Upgrade T3 Eng - Resource',
        PlatoonTemplate = 'CommanderEnhanceSorian',
        BuilderConditions = {
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'FACTORY TECH2, FACTORY TECH3'}},
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
    ...
    Builder {
        BuilderName = 'NC Seraphim CDR Upgrade T3 Eng - ResourceAdv - EnhSensor',
        PlatoonTemplate = 'CommanderEnhanceSorian',
        BuilderConditions = {
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'FACTORY TECH2, FACTORY TECH3'}},
                { SIBC, 'HaveGreaterThanUnitsWithCategory', { 3, 'MASSEXTRACTION TECH2, MASSEXTRACTION TECH3'}},
