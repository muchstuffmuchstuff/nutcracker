...
PlatoonTemplate {
    ...
    GlobalSquads = {
        { categories.MOBILE * categories.LAND - categories.EXPERIMENTAL - categories.ENGINEER - categories.xsl0402, 1, 10, 'Attack', 'GrowthFormation' }
    },
}
...
PlatoonTemplate {
    ...
    Plan = 'NavalHuntAI',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR - categories.ANTIAIR - categories.SCOUT - categories.TRANSPORTFOCUS - categories.EXPERIMENTAL, 10, 100, 'Attack', 'GrowthFormation' },
